 ...
 * @brief 是否执行系统shell命令
 */
#define     SHELL_SYSTEM_OS_COMMAND     0

/**
 * @brief 设置控制台输入/输出模式
 * @pre 0 使用命令终端,作为控制台输入/输出
 * @pre 1 使用串口,作为控制台输入/输出
 */
#define     SHELL_TERMINAL_IO_MODE         0


#if SHELL_TERMINAL_IO_MODE == 0
#define TERMINAL_PORT        (void *)0
#elif SHELL_TERMINAL_IO_MODE == 1
#define TERMINAL_PORT           TERMINAL_UART_PORT
#define TERMINAL_UART_PORT      "/dev/ttyHSL0"
#define TERMINAL_UART_BAUDRATE  115200
#define TERMINAL_UART_BITS      8
#define TERMINAL_UART_PARITY    'N'
#define TERMINAL_UART_STOP      1
#endif
